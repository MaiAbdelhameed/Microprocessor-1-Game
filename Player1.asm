...
FirstS PROC
 ...
 ReEnterN1:  clear
   ...
   Mov Cx,30
   Call recieve
   STRINGCOPY Chat_2,P2Name,30

   ;Recieve Points
   Mov Cx,5
   Call recieve
   STRINGCOPY Chat_2,P2Points,5
    
   ;Send Name 
   STRINGCOPY P1Name,Chat_2,30
   Mov Cx,30
   Call Send
   ;Send Points
   STRINGCOPY P1Points,Chat_2,5
   Mov Cx,5
   Call Send
...
GInitialPoints Proc
    ...
    ;Priting the Main for both Screens 
        ...
        Mov Cx,5
        Call recieve
        STRINGCOPY Chat_2,P2_Game_Points,5

        Push Cx
        Call recChar
        Mov Ch,0
        Mov Cl,Val
        Mov P2_Game_Points+1,Cl
        Pop Cx


        Mov Cx,5
        STRINGCOPY P1_Game_Points,Chat_2,5
        Call send

        Push Cx
        Mov Ch,0
        Mov Cl,P1_Game_Points+1   
        Mov Val,Cl
        call sendChar
        Pop Cx
...
GMainScreen Proc
    ...
    ;FOR Initializing Registers Player2
        CMP Level,'2'
    ...
    STRINGCOPY P1Command,Chat_2,7
    Mov Cx,7
    Call send
    MoveCursor 7,18
    ReadString P1Destination
    STRINGCOPY P1Destination,Chat_2,7
    Mov Cx,7
    Call send
    MoveCursor 10,18
    ReadString P1Source
    ...
    Mov Cx,7
    call recieve
    STRINGCOPY Chat_2,P2Command,7
    MoveCursor 27,18
    DisplayStringRead P2Command

    ;MoveCursor 31,18
    ;ReadString P2Destination
    Mov Cx,7
    call recieve
    STRINGCOPY Chat_2,P2Destination,7
    MoveCursor 31,18
    DisplayStringRead P2Destination
